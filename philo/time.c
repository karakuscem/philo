...
/*   Updated: 2023/07/22 22:05:12 by ckarakus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
unsigned long long	ft_real_time(t_philo *philo)
{
	...
	time_in_ms = (current_time.tv_sec
			- philo->simulation->start_time.tv_sec) * 1000;
	time_in_ms += (current_time.tv_usec
			- philo->simulation->start_time.tv_usec) / 1000;
	return (time_in_ms);
}
